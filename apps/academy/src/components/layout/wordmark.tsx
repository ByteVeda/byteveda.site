...
/**
 * The academy lockup: the org set in the page's own ink, the surface set in
 * the accent.
 *
 * The shared `Wordmark` is a leaf mark beside a lowercase word — it reads as
